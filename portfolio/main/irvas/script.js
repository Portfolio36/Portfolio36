...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var deadline = '2022-05-03';
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
  Object(_modules_validationForm__WEBPACK_IMPORTED_MODULE_5__["default"])('#width');
...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (item) {
    item.addEventListener('input', function () {
      item.value = item.value.replace(/\D/, ''); // if (item.value > 11) {
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var closeCkickOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    var trigger = document.querySelectorAll(triggerSelector),
        modal = document.querySelector(modalSelector),
        close = document.querySelector(closeSelector),
        windows = document.querySelectorAll('[data-modal]'),
        btnCalcEnd = document.querySelector('[data-btn]'),
        scroll = calcScroll();
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.marginRight = "".concat(scroll, "px"); // document.body.classList.remove('modal-open');
      });
    });
    ...
    modal.addEventListener('click', function (e) {
      if (e.target === modal && closeCkickOverlay) {
        windows.forEach(function (item) {
          item.style.display = 'none';
        });
        modal.style.display = "none";
    ...
    btnCalcEnd.addEventListener('click', function () {
      windows.forEach(function (item) {
        item.style.display = 'none';
      });
      modal.style.display = "none";
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemaing = function getTimeRemaing(endTime) {
  ...
  var setClock = function setClock(selector, endTime) {
    var timer = document.querySelector(selector),
        ...
        seconsd = document.querySelector('#seconsd'),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var validationForm = function validationForm(inputSelector, buttonSelector) {
